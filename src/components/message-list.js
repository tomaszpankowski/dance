...
class MessageList extends Component {
    ...
    render() {let content;
        ...
        return (
            <Container fluid className={"contact-s2 align-items-start p-0 py-5 bg-dark d-flex minh-footer-adj " + this.props.classExt}>
                <Row className="mx-auto text-center w-100 mt-5">
                    ...
                    <Col xs={12} md={9} className="mx-auto p-0 d-flex align-items-start p-3">
                        <Card className="w-100 minh-50vh bg-form border-secondary">
                            <Card.Body>
