...
class LoginError extends Component {
    ...
    render() {
        return (
            <Container fluid className={"contact-s2 align-items-center p-0 py-5 bg-white d-flex minh-footer-adj " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={10} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Card className="mx-auto border border-secondary rounded bg-form shadow text-dark">
